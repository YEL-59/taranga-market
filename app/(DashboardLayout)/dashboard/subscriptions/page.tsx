        ...
        <div className="space-y-12 pb-20">
            ...
            <div className="text-center space-y-4 max-w-3xl mx-auto">
                ...
                <p className="text-slate-500 text-lg font-medium leading-relaxed">
                    Scale your business with our tailored subscription tiers. From casual sellers to power merchants, we have the right features for you.
                </p>
            </div>
                    ...
                    >
                        <Card className={`relative h-full flex flex-col overflow-hidden border-2 transition-all duration-300 ${
                            ...
                            <CardHeader className="p-10 pb-6 text-center">
                                ...
                                <div className="mt-8 flex items-baseline justify-center gap-1">
                                    ...
                                    {parseFloat(plan.price) > 0 && (
                                        <span className="text-slate-400 font-bold text-lg uppercase">/mo</span>
                                    )}
                                </div>
                            </CardHeader>
                            ...
                            <CardFooter className="p-10 pt-0">
                                <Button className={`w-full h-16 rounded-[24px] font-black text-sm uppercase tracking-widest transition-all duration-300 ${
                                    index === 1 
