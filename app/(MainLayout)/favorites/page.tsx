...
import { MapPin, Heart, Calendar, Gauge, ArrowLeft, Trash2, Loader2, ShieldAlert } from 'lucide-react';
...
const FavoritesPage = () => {
    ...
    const getCategoryName = (item: any) => {
        ...
        return item.category?.name || categoryNames[item.category_id] || 'Product';
    };
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#FAFAFA]">
                ...
                <p className="text-gray-500 font-medium tracking-wide">Loading your favorites...</p>
            </div>
        );
    }
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            {isCustomer ? `You have ${favorites.length} items saved.` : "Favorites are available for customers only."}
                        </p>
                    </div>
                </div>
                ...
                <AnimatePresence mode="wait">
                    {!isCustomer ? (
                        <motion.div
                            ...
                            className="bg-white rounded-[30px] border border-dashed border-gray-200 py-24 text-center"
                        >
                            ...
                            <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                                The favorites feature is exclusively available for customer accounts. Please log in as a customer to manage your favorites.
                            </p>
                            <Link href="/login">
                                <Button className="bg-[#2A8E8E] hover:bg-[#1D7E87] text-white px-8 py-6 rounded-xl font-bold transition-all shadow-lg hover:shadow-[#2A8E8E]/20">
                                    Login as Customer
                                </Button>
                            </Link>
                        </motion.div>
                                            ...
                                            <Card className="overflow-hidden border border-gray-100 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] group flex flex-col h-full rounded-[20px] p-2.5">
                                                ...
                                                <CardContent className="flex flex-col flex-1 p-3.5 pt-4">
                                                    ...
                                                    <div className="mt-auto">
                                                        ...
                                                        <Link href={getDetailLink(item)} className="block">
                                                            <Button
                                                                variant="outline"
