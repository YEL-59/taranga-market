...
const FeaturedDetails = ({ initialData }: FeaturedDetailsProps) => {
  ...
  const { productDetails, isLoading, error } = useFeaturedProductDetails(
    id || undefined,
    initialData,
  );
          ...
          <div className="lg:col-span-8 space-y-8">
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      activeImage === img.image_path
                        ? "border-[#2A8E8E] ring-2 ring-[#2A8E8E]/20"
            ...
            <div className="bg-white p-8 rounded-[32px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <Badge
                  variant="secondary"
                  className="bg-blue-50 text-blue-600 hover:bg-blue-50 rounded-lg px-3 py-1 font-semibold border-0"
                >
              ...
              <h3 className="text-xl font-bold text-[#1B2232] mb-4">
                Description
              </h3>
            ...
            {item.values && item.values.length > 0 && (
              <div className="bg-white p-8 rounded-[32px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
                <h3 className="text-xl font-bold text-[#1B2232] mb-6">
                  {t("specifications")}
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {item.values.map((v: any, idx: number) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between p-4 rounded-2xl bg-gray-50/50 border border-gray-100"
                    >
                      <span className="text-gray-500 font-medium">
                        {v.value.split(":")[0]}
                      </span>
                      <span className="font-bold text-[#1B2232]">
                  ...
                  <Button
                    onClick={() =>
                      item.user?.phone_number
                        ? window.open(`tel:${item.user.phone_number}`, "_self")
                        : null
                    }
                    variant="outline"
              ...
              <Card className="rounded-[32px] border border-gray-100 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.04)] overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h4 className="font-bold text-lg text-[#1B2232]">
      ...
      <Dialog open={isContactModalOpen} onOpenChange={setIsContactModalOpen}>
        <DialogContent className="sm:max-w-md rounded-3xl p-6 bg-white border-0 shadow-2xl">
          <DialogHeader className="mb-4">
            <DialogTitle className="text-2xl font-bold text-[#1B2232]">
              {t("contactSeller")}
            </DialogTitle>
          </DialogHeader>
