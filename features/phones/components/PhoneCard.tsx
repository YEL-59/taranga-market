...
const PhoneCard: React.FC<PhoneCardProps> = ({ item, onClick }) => {
    ...
    return (
        ...
        >
            <div className="relative aspect-[16/10] w-full overflow-hidden bg-gray-100 rounded-[15px]">
                {image && <Image src={image} alt={item.title || "Gadget"} fill className="object-cover transition-transform duration-500 group-hover:scale-105" />}
