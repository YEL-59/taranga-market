...
import { ChevronLeft, SlidersHorizontal, Home } from 'lucide-react';
                ...
                {view === 'list' ? (
                    <div className="space-y-8 lg:space-y-10">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <h1 className="text-3xl lg:text-4xl font-extrabold text-[#1B2232] tracking-tight">Real Estate</h1>
                                <p className="text-gray-500 mt-1 text-sm lg:text-base">Find your perfect home or rental</p>
                            </div>
                                    ...
                                    <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 border-r-0">
                                        <div className="h-full overflow-y-auto pt-6 px-6 pb-10">
                                            <SheetHeader className="mb-6">
                                                <SheetTitle className="text-left text-2xl font-bold text-[#1B2232]">Property Filters</SheetTitle>
                                            </SheetHeader>
                                            <FilterSidebar 
                                                filters={filters} 
                            ...
                            <div className="flex-1 space-y-12">
                                {filteredData.length > 0 ? (
                                    ...
                                    <div className="py-24 lg:py-32 text-center bg-white rounded-[32px] border border-dashed border-gray-200">
                                        ...
                                        <p className="text-gray-400 mb-8 max-w-xs mx-auto text-sm lg:text-base">We couldn't find any properties matching your current filters. Try adjusting your criteria.</p>
