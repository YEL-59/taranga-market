        ...
        <div className={className || "w-full lg:w-[320px] bg-white border border-gray-100 rounded-[24px] p-7 shadow-sm sticky top-24 h-fit"}>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2.5">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {propertyFilterOptions.cities.map(city => (
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {propertyFilterOptions.propertyTypes.map((type) => (
                        <div key={type} className="flex items-center gap-3">
                            <input 
                                type="checkbox" 
                                id={type} 
                                checked={filters.propertyType === type}
                                onChange={() => handleSelectChange('propertyType', filters.propertyType === type ? '' : type)}
                ...
                {/* Bedrooms */}
                <div className="flex flex-col gap-2.5">
                    <label className="text-[14px] font-semibold text-gray-700">Bedrooms</label>
                    <div className="relative">
                        <select 
                            className="w-full bg-white border border-gray-200 rounded-xl py-3 px-4 text-[14px] text-gray-600 outline-none appearance-none cursor-pointer focus:border-[#1D7E87] transition-colors"
                        ...
                        >
                            ...
                            {propertyFilterOptions.bedrooms.map(num => (
